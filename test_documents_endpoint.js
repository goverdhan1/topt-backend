    ...
    rl.question('Enter the 6-digit TOTP code from your app: ', async (otp) => {
      ...
      try {
        ...
        if (documentsResponse.data.success) {
          console.log('🎉 SUCCESS: Documents endpoint is now working with authentication!');
          console.log('The "User not found or not verified" error has been resolved.');
        } else {
          console.log('❌ Documents endpoint returned error:', documentsResponse.data);
        }
