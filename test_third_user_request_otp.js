...
async function testThirdUserRequestOTP() {
    console.log('🔍 Testing /request-otp for third user');
    console.log('====================================');
    ...
    try {
        ...
        if (response.data.success) {
            console.log('✅ Request OTP successful for third user');
